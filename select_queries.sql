...
SELECT FirstName, LastName, BirthDate
FROM Client
WHERE BirthDate >= '1980-01-01' AND  BirthDate <= '1980-12-31';
...
SELECT * FROM `Login`
WHERE EmailAddress NOT LIKE '%.com%';# https://stackoverflow.com/questions/232935/sql-query-where-field-does-not-contain-x
...
SELECT InvoiceId, Description, Price, Quantity, ServiceDate, (Price > 15 AND Price <25) AS line_item_total
FROM InvoiceLineItem
WHERE Price > 15 AND Price <25;
...
SELECT * FROM `Client`
WHERE FirstName = 'Estrella' AND LastName = 'Bazely';#CLIENT ID = 87976c42-9226-4bc6-8b32-23a8cd7869a5
SELECT * FROM Login
...
FROM `Workout`
WHERE Name = 'This Is Parkour';#workout id = 12
SELECT * FROM `WorkoutGoal`
WHERE WorkoutId = 12;#goal ids returened are 3, 8, 15
SELECT * FROM Goal
